...
export default function BlogSection({ locale = "en", posts }: BlogSectionProps) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {preview.length === 0 ? (
          <motion.div
            ...
            className="px-4 py-3 rounded-lg border border-zinc-800 bg-zinc-900/40 flex items-center gap-3"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {preview.map((post, i) => (
              ...
              >
                <Link
                  href={`/blog/${post.slug}`}
                  className="group flex flex-col h-full p-6 rounded-xl border border-zinc-800 bg-zinc-900/20 hover:border-zinc-700 hover:bg-zinc-900/40 transition-all duration-300"
                >
                  {/* Tags */}
