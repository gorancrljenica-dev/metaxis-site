      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-500 text-lg max-w-xl leading-relaxed">
            Experimental AI projects — prototypes, proofs-of-concept, and novel
            ideas being explored in the open.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-zinc-500 text-sm leading-relaxed">
            Lab projects are experimental by nature — expect rough edges,
            breaking changes, and incomplete documentation.
          </p>
        </motion.div>
